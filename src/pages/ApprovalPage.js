...
const ApprovalPage = () => {
  ...
  return (
    ...
    <div className="border-2 border-red-600 flex flex-col gap-5 py-5 h-full">
      <Typography variant="h5" className="w-1/2 mb-4 text-gray-800">
            ...
            >
              ...
              <div className="flex flex-row gap-2">
                <Button
                  ...
                  onClick={() => handleApproveClick(appointment.id, "Approved")}
                >
                  Approve
                </Button>
                <Button
                  ...
                  onClick={() => handleDeclineClick(appointment.id, "Declined")}
                >
                  Decline
                </Button>
              </div>
